/**
 * Created by gewangjie on 2016/9/20.
 */
var fabric = fabric || {version: "1.4.12"};
"undefined" != typeof exports && (exports.fabric = fabric), "undefined" != typeof document && "undefined" != typeof window ? (fabric.document = document, fabric.window = window) : (fabric.document = require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"), fabric.window = fabric.document.createWindow()), fabric.isTouchSupported = "ontouchstart" in fabric.document.documentElement, fabric.isLikelyNode = "undefined" != typeof Buffer && "undefined" == typeof window, fabric.SHARED_ATTRIBUTES = ["display", "transform", "fill", "fill-opacity", "fill-rule", "opacity", "stroke", "stroke-dasharray", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width"], fabric.DPI = 96, function () {
    function t(t, e) {
    ...
    function i(e, i) {
        if (this.__eventListeners) {
            if (0 === arguments.length)this.__eventListeners = {}; else if (1 === arguments.length && "object" == typeof arguments[0])for (var r in e)t.call(this, r, e[r]); else t.call(this, e, i);
            return this
        }
    }
    ...
    var e = Math.sqrt, i = Math.atan2, r = Math.PI / 180;
    fabric.util = {
        removeFromArray: function (t, e) {
            ...
            var e = /\D{0,2}$/.exec(t), i = parseFloat(t);
            switch (e[0]) {
                case"mm":
            ...
            }, 0 !== t.indexOf("data") && "undefined" != typeof r && (s.crossOrigin = r), s.src = t
            ...
            if (i && "[object Array]" === Object.prototype.toString.call(i))for (var r = 0, s = i.length; s > r; r++)i[r] in t && (e[i[r]] = t[i[r]])
        }, drawDashedLine: function (t, r, s, n, o, a) {
            var h = n - r, c = o - s, l = e(h * h + c * c), u = i(c, h), f = a.length, d = 0, g = !0;
            ...
            for (var e = t.prototype, i = e.stateProperties.length; i--;) {
                var r = e.stateProperties[i], s = r.charAt(0).toUpperCase() + r.slice(1), n = "set" + s, o = "get" + s;
                e[o] || (e[o] = function (t) {
                    return new Function('return this.get("' + t + '")')
                }(r)), e[n] || (e[n] = function (t) {
            ...
            for (var i = [[t[0], t[2], t[4]], [t[1], t[3], t[5]], [0, 0, 1]], r = [[e[0], e[2], e[4]], [e[1], e[3], e[5]], [0, 0, 1]], s = [], n = 0; 3 > n; n++) {
                s[n] = [];
                for (var o = 0; 3 > o; o++) {
    ...
    function t(t, r, n, o, h, c, l) {
        ...
        var m = -p * t * .5 - g * r * .5, y = -p * r * .5 + g * t * .5, _ = n * n, x = o * o, C = y * y, S = m * m, w = _ * x - _ * C - x * S, O = 0;
        if (0 > w) {
            var T = Math.sqrt(1 - w / (_ * x));
            n *= T, o *= T
        } else O = (h === c ? -1 : 1) * Math.sqrt(w / (_ * C + x * S));
        var k = O * n * y / o, j = -O * o * m / n, A = p * k - g * j + .5 * t, P = g * k + p * j + .5 * r, E = i(1, 0, (m - k) / n, (y - j) / o), I = i((m - k) / n, (y - j) / o, (-m - k) / n, (-y - j) / o);
        0 === c && I > 0 ? I -= 2 * f : 1 === c && 0 > I && (I += 2 * f);
        for (var M = Math.ceil(Math.abs(I / f * 2)), D = [], L = I / M, F = 8 / 3 * Math.sin(L / 4) * Math.sin(L / 4) / Math.sin(L / 2), B = E + L, R = 0; M > R; R++)D[R] = e(E, B, p, g, n, o, A, P, F, v, b), v = D[R][4], b = D[R][5], E = B, B += L;
        return s[u] = D, D
    }
    ...
    function e(t, e, i, r, s, o, h, c, l, u, f) {
        ...
        if (n[d])return n[d];
        var g = Math.cos(t), p = Math.sin(t), v = Math.cos(e), b = Math.sin(e), m = i * s * v - r * o * b + h, y = r * s * v + i * o * b + c, _ = u + l * (-i * s * p - r * o * g), x = f + l * (-r * s * p + i * o * g), C = m + l * (i * s * b + r * o * v), S = y + l * (r * s * b - i * o * v);
        return n[d] = [_, x, C, S, m, y], n[d]
    }

    function i(t, e, i, r) {
        var s = Math.atan2(e, t), n = Math.atan2(r, i);
    ...
    function r(t, e, i, r, s, n, h, c) {
        ...
        for (var O = 0; 2 > O; ++O)if (O > 0 && (f = 6 * e - 12 * r + 6 * n, u = -3 * e + 9 * r - 9 * n + 3 * c, d = 3 * r - 3 * e), C(u) < 1e-12) {
    ...
    var s = {}, n = {}, o = {}, a = Array.prototype.join;
    fabric.util.drawArc = function (e, i, r, s) {
        for (var n = s[0], o = s[1], a = s[2], h = s[3], c = s[4], l = s[5], u = s[6], f = [[], [], [], []], d = t(l - i, u - r, n, o, h, c, a), g = 0, p = d.length; p > g; g++)f[g][0] = d[g][0] + i, f[g][1] = d[g][1] + r, f[g][2] = d[g][2] + i, f[g][3] = d[g][3] + r, f[g][4] = d[g][4] + i, f[g][5] = d[g][5] + r, e.bezierCurveTo.apply(e, f[g])
    }, fabric.util.getBoundsOfArc = function (e, i, s, n, o, a, h, c, l) {
        for (var u = 0, f = 0, d = [], g = [], p = t(c - e, l - i, s, n, a, h, o), v = 0, b = p.length; b > v; v++)d = r(u, f, p[v][0], p[v][1], p[v][2], p[v][3], p[v][4], p[v][5]), d[0].x += e, d[0].y += i, d[1].x += e, d[1].y += i, g.push(d[0]), g.push(d[1]), u = p[v][4], f = p[v][5];
        return g
    ...
    function r(t, e, i) {
        if (t && 0 !== t.length) {
            var r = t.length - 1, s = e ? t[r][e] : t[r];
            if (e)for (; r--;)i(t[r][e], s) && (s = t[r][e]); else for (; r--;)i(t[r], s) && (s = t[r]);
            return s
        }
    }
    ...
    Function.prototype.bind || (Function.prototype.bind = function (r) {
        var s, n = this, o = t.call(arguments, 1);
        ...
        }, i.prototype = this.prototype, s.prototype = new i, s
    })
}(), function () {
    function t() {
    }
    ...
    function i() {
        ...
        var n = null, a = r.call(arguments, 0);
    ...
    var r = Array.prototype.slice, s = function () {
    }, n = function () {
        ...
        }(r) : e[r], n && (e.toString !== Object.prototype.toString && (t.prototype.toString = e.toString), e.valueOf !== Object.prototype.valueOf && (t.prototype.valueOf = e.valueOf))
    };
    fabric.util.createClass = i
}(), function () {
    function t(t) {
        var e, i, r = Array.prototype.slice.call(arguments, 1), s = r.length;
    ...
    function r(t, e) {
        return function (i) {
            if (p[t] && p[t][e])for (var r = p[t][e], s = 0, n = r.length; n > s; s++)r[s].call(this, i || fabric.window.event)
        }
    }
    ...
    f ? (l = function (t, e, i) {
        ...
        var r, s = c(t);
        if (g[s] && g[s][e])for (var n = 0, o = g[s][e].length; o > n; n++)r = g[s][e][n], r && r.handler === i && (t.detachEvent("on" + e, r.wrappedHandler), g[s][e][n] = null)
    }) : (l = function (t, e, i) {
        var s = c(t);
        if (p[s] || (p[s] = {}), !p[s][e]) {
            p[s][e] = [];
        ...
        var r = c(t);
        if (p[r] && p[r][e])for (var s = p[r][e], n = 0, o = s.length; o > n; n++)s[n] === i && s.splice(n, 1)
    ...
    }), fabric.util.getPointer = s, fabric.util.object.extend(fabric.util, fabric.Observable)
}(), function () {
    function t(t, e) {
        var i = t.style;
        if (!i)return t;
        if ("string" == typeof e)return t.style.cssText += ";" + e, e.indexOf("opacity") > -1 ? n(t, e.match(/opacity:\s*(\d?\.?\d*)/)[1]) : t;
        for (var r in e)if ("opacity" === r)n(t, e[r]); else {
    ...
    var e = fabric.document.createElement("div"), i = "string" == typeof e.style.opacity, r = "string" == typeof e.style.filter, s = /alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/, n = function (t) {
        return t
    };
    i ? n = function (t, e) {
        ...
        var i = t.style;
        return t.currentStyle && !t.currentStyle.hasLayout && (i.zoom = 1), s.test(i.filter) ? (e = e >= .9999 ? "" : "alpha(opacity=" + 100 * e + ")", i.filter = i.filter.replace(s, e)) : i.filter += " alpha(opacity=" + 100 * e + ")", t
    ...
    function s(t, e) {
        var i, r, s = 0, n = 0, o = fabric.document.documentElement, a = fabric.document.body || {
                scrollLeft: 0,
                scrollTop: 0
            };
    ...
    function n(t) {
        var e, i, r = t && t.ownerDocument, s = {left: 0, top: 0}, n = {left: 0, top: 0}, o = {
        ...
        return e = r.documentElement, "undefined" != typeof t.getBoundingClientRect && (s = t.getBoundingClientRect()), i = fabric.util.getScrollLeftTop(t, null), {
    ...
    l = fabric.document.defaultView && fabric.document.defaultView.getComputedStyle ? function (t, e) {
        ...
        function t(t, e) {
            var i = fabric.document.getElementsByTagName("head")[0], r = fabric.document.createElement("script"), s = !0;
    ...
    function i(i, s) {
        s || (s = {});
        var n, o = s.method ? s.method.toUpperCase() : "GET", a = s.onComplete || function () {
            }, h = r();
        return h.onreadystatechange = function () {
            4 === h.readyState && (a(h), h.onreadystatechange = e)
        }, "GET" === o && (n = null, "string" == typeof s.parameters && (i = t(i, s.parameters))), h.open(o, i, !0), ("POST" === o || "PUT" === o) && h.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), h.send(n), h
    }
    ...
    function t(t) {
        e(function (i) {
            t || (t = {});
            var r, s = i || +new Date, n = t.duration || 500, o = s + n, a = t.onChange || function () {
                }, h = t.abort || function () {
                    return !1
    ...
    function w(t, e, i, r, s) {
        return void 0 === s && (s = 1.70158), t /= r / 2, 1 > t ? i / 2 * t * t * (((s *= 1.525) + 1) * t - s) + e : i / 2 * ((t -= 2) * t * (((s *= 1.525) + 1) * t + s) + 2) + e
    }
    ...
    function i(t, e, i) {
        ...
        return "fill" !== t && "stroke" !== t || "none" !== e ? "strokeDashArray" === t ? e = e.replace(/,/g, " ").split(/\s+/).map(function (t) {
            return parseFloat(t)
        }) : "transformMatrix" === t ? e = i && i.transformMatrix ? x(i.transformMatrix, p.parseTransformAttribute(e)) : p.parseTransformAttribute(e) : "visible" === t ? (e = "none" === e || "hidden" === e ? !1 : !0, i && i.visible === !1 && (e = !1)) : "originX" === t ? e = "start" === e ? "left" : "end" === e ? "right" : "center" : r = s ? e.map(_) : _(e) : e = "", !s && isNaN(r) ? e : r
    }

    function r(t) {
        for (var e in S)if (t[e] && "undefined" != typeof t[S[e]] && 0 !== t[e].indexOf("url(")) {
    ...
    function s(t, e) {
        ...
        if (i) {
            var r = i[1], s = i[3], n = i[4], o = i[5], a = i[6];
            r && (e.fontStyle = r), s && (e.fontWeight = isNaN(parseFloat(s)) ? s : parseFloat(s)), n && (e.fontSize = parseFloat(n)), a && (e.fontFamily = a), o && (e.lineHeight = "normal" === o ? 1 : o)
        }
    }
    ...
    function n(t, r) {
        ...
        t.replace(/;$/, "").split(";").forEach(function (t) {
            var a = t.split(":");
            n = e(a[0].trim().toLowerCase()), o = i(n, a[1].trim()), "font" === n ? s(o, r) : r[n] = o
        })
    }

    function o(t, r) {
        var n, o;
        for (var a in t)"undefined" != typeof t[a] && (n = e(a.toLowerCase()), o = i(n, t[a]), "font" === n ? s(o, r) : r[n] = o)
    }

    function a(t, e) {
        var i = {};
        for (var r in p.cssRules[e])if (h(t, r.split(" ")))for (var s in p.cssRules[e][r])i[s] = p.cssRules[e][r][s];
        return i
    }
    ...
    function l(t, e) {
        var i, r = t.nodeName, s = t.getAttribute("class"), n = t.getAttribute("id");
    ...
    function u(t) {
        for (var e = t.getElementsByTagName("use"); e.length;) {
            for (var i, r = e[0], s = r.getAttribute("xlink:href").substr(1), n = r.getAttribute("x") || 0, o = r.getAttribute("y") || 0, a = t.getElementById(s).cloneNode(!0), h = (r.getAttribute("transform") || "") + " translate(" + n + ", " + o + ")", c = 0, l = r.attributes, u = l.length; u > c; c++) {
                var f = l.item(c);
                "x" !== f.nodeName && "y" !== f.nodeName && "xlink:href" !== f.nodeName && ("transform" === f.nodeName ? h = h + " " + f.nodeValue : a.setAttribute(f.nodeName, f.nodeValue))
            }
            a.setAttribute("transform", h), a.removeAttribute("id"), i = r.parentNode, i.replaceChild(a, r)
        }
    }
    ...
    var p = t.fabric || (t.fabric = {}), v = p.util.object.extend, b = p.util.string.capitalize, m = p.util.object.clone, y = p.util.toFixed, _ = p.util.parseUnit, x = p.util.multiplyTransformMatrices, C = {
        cx: "left",
        x: "left",
        r: "radius",
        cy: "top",
    ...
    p.cssRules = {}, p.gradientDefs = {}, p.parseTransformAttribute = function () {
        ...
        var n = [1, 0, 0, 1, 0, 0], o = "(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)", a = "(?:\\s+,?\\s*|,\\s*)", h = "(?:(skewX)\\s*\\(\\s*(" + o + ")\\s*\\))", c = "(?:(skewY)\\s*\\(\\s*(" + o + ")\\s*\\))", l = "(?:(rotate)\\s*\\(\\s*(" + o + ")(?:" + a + "(" + o + ")" + a + "(" + o + "))?\\s*\\))", u = "(?:(scale)\\s*\\(\\s*(" + o + ")(?:" + a + "(" + o + "))?\\s*\\))", f = "(?:(translate)\\s*\\(\\s*(" + o + ")(?:" + a + "(" + o + "))?\\s*\\))", d = "(?:(matrix)\\s*\\(\\s*(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")" + a + "(" + o + ")\\s*\\))", g = "(?:" + d + "|" + f + "|" + u + "|" + l + "|" + h + "|" + c + ")", v = "(?:" + g + "(?:" + a + g + ")*)", b = "^\\s*(?:" + v + "?)\\s*$", m = new RegExp(b), y = new RegExp(g, "g");
        return function (o) {
            var a = n.concat(), h = [];
        ...
        var e = /^(path|circle|polygon|polyline|ellipse|rect|line|image|text)$/, i = "(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)", r = new RegExp("^\\s*(" + i + "+)\\s*,?\\s*(" + i + "+)\\s*,?\\s*(" + i + "+)\\s*,?\\s*(" + i + "+)\\s*$");
        return function (i, s, n) {
            if (i) {
                var o = new Date, a = p.Object.__uid++;
                u(i);
                var h, c, l = i.getAttribute("viewBox"), d = _(i.getAttribute("width") || "100%"), g = _(i.getAttribute("height") || "100%");
                if (l && (l = l.match(r))) {
                    var v = parseFloat(l[1]), b = parseFloat(l[2]), y = 1, x = 1;
                    h = parseFloat(l[3]), c = parseFloat(l[4]), d && d !== h && (y = d / h), g && g !== c && (x = g / c), f(i, [y, 0, 0, x, y * -v, x * -b])
                }
                var C = p.util.toArray(i.getElementsByTagName("*"));
                if (0 === C.length && p.isLikelyNode) {
                    C = i.selectNodes('//*[name(.)!="svg"]');
                    for (var S = [], w = 0, O = C.length; O > w; w++)S[w] = C[w];
                    C = S
                }
                var T = C.filter(function (i) {
                    return e.test(i.tagName) && !t(i, /^(?:pattern|defs)$/)
                });
                if (!T || T && !T.length)return void(s && s([], {}));
                var k = {width: d ? d : h, height: g ? g : c, widthAttr: d, heightAttr: g, svgUid: a};
                p.gradientDefs[a] = p.getGradientDefs(i), p.cssRules[a] = p.getCSSRules(i), p.parseElements(T, function (t) {
                    p.documentParsingTime = new Date - o, s && s(t, k)
                }, m(k), n)
            }
        }
    }();
    ...
    v(p, {
        getGradientDefs: function (t) {
            var e, i, r, s, n = t.getElementsByTagName("linearGradient"), o = t.getElementsByTagName("radialGradient"), a = 0, h = [], c = {}, l = {};
            ...
            if (t) {
                var o, h = {};
                "undefined" == typeof n && (n = t.getAttribute("svgUid")), t.parentNode && /^symbol|[g|a]$/i.test(t.parentNode.nodeName) && (h = p.parseAttributes(t.parentNode, s, n));
                var c = s.reduce(function (r, s) {
                    return o = t.getAttribute(s), o && (s = e(s), o = i(s, o, h), r[s] = o), r
                }, {});
                return c = v(c, v(a(t, n), p.parseStyleAttribute(t))), r(v(h, c))
            }
        }, parseElements: function (t, e, i, r) {
            new p.ElementsParser(t, e, i, r).parse()
        }, parseStyleAttribute: function (t) {
            var e = {}, i = t.getAttribute("style");
            return i ? ("string" == typeof i ? n(i, e) : o(i, e), e) : e
            ...
            for (var r, s = t.getElementsByTagName("style"), n = {}, o = 0, a = s.length; a > o; o++) {
                ...
                h = h.replace(/\/\*[\s\S]*?\*\//g, ""), "" !== h.trim() && (r = h.match(/[^{]*\{[\s\S]*?\}/g), r = r.map(function (t) {
                    ...
                    t = r[1], t.split(",").forEach(function (t) {
                        n[t.trim()] = p.util.object.clone(s)
                    })
                }))
            }
            return n
            ...
            function r(r) {
                var s = r.responseXML;
                s && !s.documentElement && p.window.ActiveXObject && r.responseText && (s = new ActiveXObject("Microsoft.XMLDOM"), s.async = "false", s.loadXML(r.responseText.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i, ""))), s && s.documentElement && p.parseSVGDocument(s.documentElement, function (i, r) {
                    w.set(t, {objects: p.util.array.invoke(i, "toObject"), options: r}), e(i, r)
                }, i)
            }

            t = t.replace(/^\n\s*/, "").trim(), w.has(t, function (i) {
                i ? w.get(t, function (t) {
                    var i = d(t);
    ...
    return i.Intersection ? void i.warn("fabric.Intersection is already defined") : (i.Intersection = e, i.Intersection.prototype = {
        ...
        var o, a = (n.x - s.x) * (t.y - s.y) - (n.y - s.y) * (t.x - s.x), h = (r.x - t.x) * (t.y - s.y) - (r.y - t.y) * (t.x - s.x), c = (n.y - s.y) * (r.x - t.x) - (n.x - s.x) * (r.y - t.y);
        if (0 !== c) {
            var l = a / c, u = h / c;
        ...
        for (var s = new e, n = r.length, o = 0; n > o; o++) {
            var a = r[o], h = r[(o + 1) % n], c = e.intersectLineLine(t, i, a, h);
        ...
        for (var r = new e, s = t.length, n = 0; s > n; n++) {
            var o = t[n], a = t[(n + 1) % s], h = e.intersectLinePolygon(o, a, i);
            r.appendPoints(h.points)
        }
        return r.points.length > 0 && (r.status = "Intersection"), r
    }, void(i.Intersection.intersectPolygonRectangle = function (t, r, s) {
        var n = r.min(s), o = r.max(s), a = new i.Point(o.x, n.y), h = new i.Point(n.x, o.y), c = e.intersectLinePolygon(n, a, t), l = e.intersectLinePolygon(a, o, t), u = e.intersectLinePolygon(o, h, t), f = e.intersectLinePolygon(h, n, t), d = new e;
    ...
    return r.Color ? void r.warn("fabric.Color is already defined.") : (r.Color = e, r.Color.prototype = {
        ...
        if (i) {
            var r = parseInt(i[1], 10) / (/%$/.test(i[1]) ? 100 : 1) * (/%$/.test(i[1]) ? 255 : 1), s = parseInt(i[2], 10) / (/%$/.test(i[2]) ? 100 : 1) * (/%$/.test(i[2]) ? 255 : 1), n = parseInt(i[3], 10) / (/%$/.test(i[3]) ? 100 : 1) * (/%$/.test(i[3]) ? 255 : 1);
        ...
        if (r) {
            var s, n, o, a = (parseFloat(r[1]) % 360 + 360) % 360 / 360, h = parseFloat(r[2]) / (/%$/.test(r[2]) ? 100 : 1), c = parseFloat(r[3]) / (/%$/.test(r[3]) ? 100 : 1);
            if (0 === h)s = n = o = c; else {
        ...
        if (t.match(e.reHex)) {
            var i = t.slice(t.indexOf("#") + 1), r = 3 === i.length, s = r ? i.charAt(0) + i.charAt(0) : i.substring(0, 2), n = r ? i.charAt(1) + i.charAt(1) : i.substring(2, 4), o = r ? i.charAt(2) + i.charAt(2) : i.substring(4, 6);
    ...
    function t(t) {
        var e, i, r, s = t.getAttribute("style"), n = t.getAttribute("offset");
    ...
    fabric.Gradient = fabric.util.createClass({
        offsetX: 0, offsetY: 0, initialize: function (t) {
            ...
            if (this.colorStops.sort(function (t, e) {
                ...
                }), !t.group || "path-group" !== t.group.type)for (var s in r)"x1" === s || "x2" === s || "r2" === s ? r[s] += this.offsetX - t.width / 2 : ("y1" === s || "y2" === s) && (r[s] += this.offsetY - t.height / 2);
            ...
            var i, r = fabric.util.object.clone(this.coords);
            if (this.type) {
                ...
                for (var n = 0, o = this.colorStops.length; o > n; n++) {
                    var a = this.colorStops[n].color, h = this.colorStops[n].opacity, c = this.colorStops[n].offset;
        ...
        fromElement: function (s, n) {
            var o, a = s.getElementsByTagName("stop"), h = "linearGradient" === s.nodeName ? "linear" : "radial", c = s.getAttribute("gradientUnits") || "objectBoundingBox", l = s.getAttribute("gradientTransform"), u = [], f = {};
    ...
    repeat: "repeat", offsetX: 0, offsetY: 0, initialize: function (t) {
        ...
        var e = "function" == typeof this.source ? this.source() : this.source, i = e.width / t.getWidth(), r = e.height / t.getHeight(), s = "";
        return e.src ? s = e.src : e.toDataURL && (s = e.toDataURL()), '<pattern id="SVGID_' + this.id + '" x="' + this.offsetX + '" y="' + this.offsetY + '" width="' + i + '" height="' + r + '"><image x="0" y="0" width="' + e.width + '" height="' + e.height + '" xlink:href="' + s + '"></image></pattern>'
    }, toLive: function (t) {
    ...
    return e.Shadow ? void e.warn("fabric.Shadow is already defined.") : (e.Shadow = e.util.createClass({
        ...
        _parseShadow: function (t) {
            var i = t.trim(), r = e.Shadow.reOffsetsAndBlur.exec(i) || [], s = i.replace(e.Shadow.reOffsetsAndBlur, "") || "rgb(0,0,0)";
            return {
                color: s.trim(),
    ...
    fabric.StaticCanvas = fabric.util.createClass({
        ...
        _renderObjects: function (t, e) {
            var i, r;
            if (!e || this.preserveObjectStacking)for (i = 0, r = this._objects.length; r > i; ++i)this._draw(t, this._objects[i]); else for (i = 0, r = this._objects.length; r > i; ++i)this._objects[i] && !e.contains(this._objects[i]) && this._draw(t, this._objects[i])
        },
        ...
        _toObjectMethod: function (e, i) {
            ...
            return t(s, this.__serializeBgOverlay()), fabric.util.populateWithProperties(this, s, i), r && (this.setActiveGroup(new fabric.Group(r.getObjects(), {
                originX: "center",
                originY: "center"
            })), r.forEachObject(function (t) {
                t.set("active", !0)
            }), this._currentTransform && (this._currentTransform.target = this.getActiveGroup())), s
        },
    ...
    width: 10, initialize: function (t) {
        ...
        for (var e = [], i = 0, r = this.points.length; r > i; i++) {
            var s = this.points[i], n = new fabric.Circle({
                radius: s.radius,
                left: s.x,
                top: s.y,
                originX: "center",
    ...
    onMouseUp: function () {
        var t = this.canvas.renderOnAddRemove;
        this.canvas.renderOnAddRemove = !1;
        for (var e = [], i = 0, r = this.sprayChunks.length; r > i; i++)for (var s = this.sprayChunks[i], n = 0, o = s.length; o > n; n++) {
    ...
    _getOptimizedRects: function (t) {
        for (var e, i = {}, r = 0, s = t.length; s > r; r++)e = t[r].left + "" + t[r].top, i[e] || (i[e] = t[r]);
        var n = [];
    ...
    var t = fabric.util.getPointer, e = fabric.util.degreesToRadians, i = fabric.util.radiansToDegrees, r = Math.atan2, s = Math.abs, n = .5;
    fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
        ...
        _normalizePointer: function (t, e) {
            var i, r = this.getActiveGroup(), s = e.x, n = e.y, o = r && "group" !== t.type && r.contains(t);
        ...
        isTargetTransparent: function (t, e, i) {
            var r = t.hasBorders, s = t.transparentCorners;
        ...
        _getActionFromCorner: function (t, e) {
            var i = "drag";
            return e && (i = "ml" === e || "mr" === e ? "scaleX" : "mt" === e || "mb" === e ? "scaleY" : "tr" === e ? "rotate" : "tl" === e ? "move" : "bl" === e ? "remove" : "scale"), i
        },
        _setupCurrentTransform: function (t, i) {
            if (i) {
                var r = this.getPointer(t), s = i._findTargetCorner(this.getPointer(t, !0)), n = this._getActionFromCorner(i, s), o = this._getOriginFromCorner(i, s);
                if ("remove" == n)return void(this.getActiveGroup() && "undefined" != this.getActiveGroup() ? (this.getActiveGroup().forEachObject(function (t) {
                    t.remove()
                }), this.discardActiveGroup()) : i.isType("curvedText") || i.isType("group") ? i.canvas.remove(i) : i.remove());
        ...
        _scaleObject: function (t, e, i) {
            var r = this._currentTransform, s = r.target, n = s.get("lockScalingX"), o = s.get("lockScalingY"), a = s.get("lockScalingFlip");
            if (!n || !o) {
        ...
        _setLocalMouse: function (t, e) {
            var i = e.target;
            "right" === e.originX ? t.x *= -1 : "center" === e.originX && (t.x *= 2 * e.mouseXSign, t.x < 0 && (e.mouseXSign = -e.mouseXSign)), "bottom" === e.originY ? t.y *= -1 : "center" === e.originY && (t.y *= 2 * e.mouseYSign, t.y < 0 && (e.mouseYSign = -e.mouseYSign)), s(t.x) > i.padding ? t.x < 0 ? t.x += i.padding : t.x -= i.padding : t.x = 0, s(t.y) > i.padding ? t.y < 0 ? t.y += i.padding : t.y -= i.padding : t.y = 0
        },
        _rotateObject: function (t, e) {
            var s = this._currentTransform;
            if (!s.target.get("lockRotation")) {
                var n = r(s.ey - s.top, s.ex - s.left), o = r(e - s.top, t - s.left), a = i(o - n + s.theta);
                0 > a && (a = 360 + a), s.target.angle = a
            }
        },
        ...
        _drawSelection: function () {
            var t = this.contextTop, e = this._groupSelector, i = e.left, r = e.top, o = s(i), a = s(r);
            if (t.fillStyle = this.selectionColor, t.fillRect(e.ex - (i > 0 ? 0 : -i), e.ey - (r > 0 ? 0 : -r), o, a), t.lineWidth = this.selectionLineWidth, t.strokeStyle = this.selectionBorderColor, this.selectionDashArray.length > 1) {
                var h = e.ex + n - (i > 0 ? 0 : o), c = e.ey + n - (r > 0 ? 0 : a);
        ...
        _searchPossibleTargets: function (t) {
            for (var e, i = this.getPointer(t, !0), r = this._objects.length; r--;)if (this._checkTarget(t, this._objects[r], i)) {
        ...
        getPointer: function (e, i, r) {
            ...
            return a && h || ("top" in o && "bottom" in o && (h = Math.abs(o.top - o.bottom)), "right" in o && "left" in o && (a = Math.abs(o.right - o.left))), this.calcOffset(), n.x = n.x - this._offset.left, n.y = n.y - this._offset.top, i || (n = fabric.util.transformPoint(n, fabric.util.invertTransform(this.viewportTransform))), s = 0 === a || 0 === h ? {
                width: 1,
                height: 1
            } : {width: r.width / a, height: r.height / h}, {x: n.x * s.width, y: n.y * s.height}
        },
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        cursorMap: ["pointer", "pointer", "pointer", "pointer", "pointer", "pointer", "pointer", "pointer"],
        ...
        __onMouseDown: function (t) {
            ...
            if (e || fabric.isTouchSupported) {
                ...
                if (!this._currentTransform) {
                    ...
                    this._shouldClearSelection(t, i) ? this._clearSelection(t, i, r) : n && (this._handleGrouping(t, i), i = this.getActiveGroup()), i && i.selectable && !n && (this._beforeTransform(t, i), this._setupCurrentTransform(t, i)), s && this.renderAll(), this.fire("mouse:down", {
                        target: i,
                        e: t
        ...
        _performTransformAction: function (t, e, i) {
            var r = i.x, s = i.y, n = e.target, o = e.action;
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        _shouldGroup: function (t, e) {
            ...
            return new fabric.Group(r, {originX: "center", originY: "center", canvas: this})
            ...
            1 === e.length ? this.setActiveObject(e[0], t) : e.length > 1 && (e = new fabric.Group(e.reverse(), {
                ...
                originY: "center",
                canvas: this
            }), e.addWithUpdate(), this.setActiveGroup(e, t), e.saveCoords(), this.fire("selection:created", {target: e}), this.renderAll())
    ...
    toDataURL: function (t) {
        t || (t = {});
        var e = t.format || "png", i = t.quality || 1, r = t.multiplier || 1, s = {
            left: t.left,
            top: t.top,
            width: t.width,
            height: t.height
        ...
        var i, r, s = "left" in e || "top" in e || "width" in e || "height" in e;
        ...
        var s = this.getWidth(), n = this.getHeight(), o = s * r, a = n * r, h = this.getActiveObject(), c = this.getActiveGroup(), l = this.contextTop || this.contextContainer;
    ...
    e.Object || (e.Object = e.util.createClass({
        ...
        toObject: function (t) {
            var i = e.Object.NUM_FRACTION_DIGITS, s = {
                type: this.type,
        ...
        _set: function (t, i) {
            ...
            return s && (i = this._constrainScale(i)), "scaleX" === t && 0 > i ? (this.flipX = !this.flipX, i *= -1) : "scaleY" === t && 0 > i ? (this.flipY = !this.flipY, i *= -1) : "width" === t || "height" === t ? this.minScaleLimit = r(Math.min(.1, 1 / Math.max(this.width, this.height)), 2) : "shadow" !== t || !i || i instanceof e.Shadow || (i = new e.Shadow(i)), this[t] = i, this
        },
        toggle: function (t) {
            var e = this.get(t);
        ...
        _renderControls: function (t, i) {
            ...
            if (t.save(), this.active && !i) {
                var s;
                this.group && (s = e.util.transformPoint(this.group.getCenterPoint(), r), t.translate(s.x, s.y), t.rotate(n(this.group.angle))), s = e.util.transformPoint(this.getCenterPoint(), r, null != this.group), this.group && (s.x *= this.group.scaleX, s.y *= this.group.scaleY), t.translate(s.x, s.y), t.rotate(n(this.angle)), this.drawBorders(t), this.drawControls(t)
            }
            t.restore()
        },
        ...
        _renderStroke: function (t) {
            if (this.stroke && 0 !== this.strokeWidth) {
                if (t.save(), this.strokeDashArray)1 & this.strokeDashArray.length && this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray), o ? (t.setLineDash(this.strokeDashArray), this._stroke && this._stroke(t)) : this._renderDashedStroke && this._renderDashedStroke(t), t.stroke(); else {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        translateToCenterPoint: function (e, i, r) {
            var s = e.x, n = e.y, o = this.stroke ? this.strokeWidth : 0;
            return "left" === i ? s = e.x + (this.getWidth() + o * this.scaleX) / 2 : "right" === i && (s = e.x - (this.getWidth() + o * this.scaleX) / 2), "top" === r ? n = e.y + (this.getHeight() + o * this.scaleY) / 2 : "bottom" === r && (n = e.y - (this.getHeight() + o * this.scaleY) / 2), fabric.util.rotatePoint(new fabric.Point(s, n), e, t(this.angle))
            ...
            var s, n, o = this.getCenterPoint(), a = this.stroke ? this.strokeWidth : 0;
            return i && r ? (s = "left" === i ? o.x - (this.getWidth() + a * this.scaleX) / 2 : "right" === i ? o.x + (this.getWidth() + a * this.scaleX) / 2 : o.x, n = "top" === r ? o.y - (this.getHeight() + a * this.scaleY) / 2 : "bottom" === r ? o.y + (this.getHeight() + a * this.scaleY) / 2 : o.y) : (s = this.left, n = this.top), fabric.util.rotatePoint(new fabric.Point(e.x, e.y), o, -t(this.angle)).subtractEquals(new fabric.Point(s, n))
        }, setPositionByOrigin: function (t, e, i) {
            var r = this.translateToCenterPoint(t, e, i), s = this.translateToOriginPoint(r, this.originX, this.originY);
            this.set("left", s.x), this.set("top", s.y)
        }, adjustPosition: function (e) {
            var i = t(this.angle), r = this.getWidth() / 2, s = Math.cos(i) * r, n = Math.sin(i) * r, o = this.getWidth(), a = Math.cos(i) * o, h = Math.sin(i) * o;
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        oCoords: null, intersectsWithRect: function (t, e) {
            var i = this.oCoords, r = new fabric.Point(i.tl.x, i.tl.y), s = new fabric.Point(i.tr.x, i.tr.y), n = new fabric.Point(i.bl.x, i.bl.y), o = new fabric.Point(i.br.x, i.br.y), a = fabric.Intersection.intersectPolygonRectangle([r, s, o, n], t, e);
            ...
            var i = e(this.oCoords), r = e(t.oCoords), s = fabric.Intersection.intersectPolygonPolygon([i.tl, i.tr, i.br, i.bl], [r.tl, r.tr, r.br, r.bl]);
            ...
            var e = this.strokeWidth > 1 ? this.strokeWidth : 0, i = t(this.angle), r = this.getViewportTransform(), s = function (t) {
                return fabric.util.transformPoint(t, r)
            }, n = this.width, o = this.height, a = "round" === this.strokeLineCap || "square" === this.strokeLineCap, h = "line" === this.type && 1 === this.width, c = "line" === this.type && 1 === this.height, l = a && c || "line" !== this.type, u = a && h || "line" !== this.type;
            h ? n = e : c && (o = e), l && (n += e), u && (o += e), this.currentWidth = n * this.scaleX, this.currentHeight = o * this.scaleY, this.currentWidth < 0 && (this.currentWidth = Math.abs(this.currentWidth));
            var f = Math.sqrt(Math.pow(this.currentWidth / 2, 2) + Math.pow(this.currentHeight / 2, 2)), d = Math.atan(isFinite(this.currentHeight / this.currentWidth) ? this.currentHeight / this.currentWidth : 0), g = Math.cos(d + i) * f, p = Math.sin(d + i) * f, v = Math.sin(i), b = Math.cos(i), m = this.getCenterPoint(), y = new fabric.Point(this.currentWidth, this.currentHeight), _ = new fabric.Point(m.x - g, m.y - p), x = new fabric.Point(_.x + y.x * b, _.y + y.x * v), C = new fabric.Point(_.x - y.y * v, _.y + y.y * b), S = new fabric.Point(_.x + y.x / 2 * b, _.y + y.x / 2 * v), w = s(_), O = s(x), T = s(new fabric.Point(x.x - y.y * v, x.y + y.y * b)), k = s(C), j = s(new fabric.Point(_.x - y.y / 2 * v, _.y + y.y / 2 * b)), A = s(S), P = s(new fabric.Point(x.x - y.y / 2 * v, x.y + y.y / 2 * b)), E = s(new fabric.Point(C.x + y.x / 2 * b, C.y + y.x / 2 * v)), I = s(new fabric.Point(S.x, S.y)), M = Math.cos(d + i) * this.padding * Math.sqrt(2), D = Math.sin(d + i) * this.padding * Math.sqrt(2);
            return w = w.add(new fabric.Point(-M, -D)), O = O.add(new fabric.Point(D, -M)), T = T.add(new fabric.Point(M, D)), k = k.add(new fabric.Point(-D, M)), j = j.add(new fabric.Point((-M - D) / 2, (-D + M) / 2)), A = A.add(new fabric.Point((D - M) / 2, -(D + M) / 2)), P = P.add(new fabric.Point((D + M) / 2, (D - M) / 2)), E = E.add(new fabric.Point((M - D) / 2, (M + D) / 2)), I = I.add(new fabric.Point((D - M) / 2, -(D + M) / 2)), this.oCoords = {
                tl: w,
                tr: O,
                br: T,
                bl: k,
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        _controlsVisibility: null, _findTargetCorner: function (t) {
            ...
            var e, i, r = t.x, s = t.y;
            for (var n in this.oCoords)if (this.isControlVisible(n) && ("mtr" !== n || this.hasRotatingPoint) && (!this.get("lockUniScaling") || "mt" !== n && "mr" !== n && "mb" !== n && "ml" !== n) && (i = this._getImageLines(this.oCoords[n].corner), e = this._findCrossPoints({
                    x: r,
                    y: s
                }, i), 0 !== e && e % 2 === 1))return this.__corner = n, n;
            return !1
        }, _setCornerCoords: function () {
            var e = this.oCoords, i = t(this.angle), r = t(45 - this.angle), s = Math.sqrt(2 * Math.pow(this.cornerSize, 2)) / 2, n = s * Math.cos(r), o = s * Math.sin(r), a = Math.sin(i), h = Math.cos(i);
            e.tl.corner = {
                tl: {x: e.tl.x - o, y: e.tl.y - n},
                tr: {x: e.tl.x + n, y: e.tl.y - o},
                bl: {x: e.tl.x - n, y: e.tl.y + o},
                br: {x: e.tl.x + o, y: e.tl.y + n}
            }, e.tr.corner = {
                tl: {x: e.tr.x - o, y: e.tr.y - n},
                tr: {x: e.tr.x + n, y: e.tr.y - o},
                br: {x: e.tr.x + o, y: e.tr.y + n},
                bl: {x: e.tr.x - n, y: e.tr.y + o}
            }, e.bl.corner = {
                tl: {x: e.bl.x - o, y: e.bl.y - n},
                bl: {x: e.bl.x - n, y: e.bl.y + o},
                br: {x: e.bl.x + o, y: e.bl.y + n},
                tr: {x: e.bl.x + n, y: e.bl.y - o}
            }, e.br.corner = {
                tr: {x: e.br.x + n, y: e.br.y - o},
                bl: {x: e.br.x - n, y: e.br.y + o},
                br: {x: e.br.x + o, y: e.br.y + n},
                tl: {x: e.br.x - o, y: e.br.y - n}
            }, e.ml.corner = {
                tl: {x: e.ml.x - o, y: e.ml.y - n},
                tr: {x: e.ml.x + n, y: e.ml.y - o},
                bl: {x: e.ml.x - n, y: e.ml.y + o},
                br: {x: e.ml.x + o, y: e.ml.y + n}
            }, e.mt.corner = {
                tl: {x: e.mt.x - o, y: e.mt.y - n},
                tr: {x: e.mt.x + n, y: e.mt.y - o},
                bl: {x: e.mt.x - n, y: e.mt.y + o},
                br: {x: e.mt.x + o, y: e.mt.y + n}
            }, e.mr.corner = {
                tl: {x: e.mr.x - o, y: e.mr.y - n},
                tr: {x: e.mr.x + n, y: e.mr.y - o},
                bl: {x: e.mr.x - n, y: e.mr.y + o},
                br: {x: e.mr.x + o, y: e.mr.y + n}
            }, e.mb.corner = {
                tl: {x: e.mb.x - o, y: e.mb.y - n},
                tr: {x: e.mb.x + n, y: e.mb.y - o},
                bl: {x: e.mb.x - n, y: e.mb.y + o},
                br: {x: e.mb.x + o, y: e.mb.y + n}
            }, e.mtr.corner = {
                tl: {
            ...
            var e = this.padding, i = 2 * e, r = this.getViewportTransform();
            t.save(), t.globalAlpha = this.isMoving ? this.borderOpacityWhenMoving : 1, t.strokeStyle = this.borderColor;
            var s = 1 / this._constrainScale(this.scaleX), n = 1 / this._constrainScale(this.scaleY);
            t.lineWidth = 1 / this.borderScaleFactor;
            var o = this.getWidth(), a = this.getHeight(), h = this.strokeWidth > 1 ? this.strokeWidth : 0, c = "round" === this.strokeLineCap || "square" === this.strokeLineCap, l = "line" === this.type && 1 === this.width, u = "line" === this.type && 1 === this.height, f = c && u || "line" !== this.type, d = c && l || "line" !== this.type;
            l ? o = h / s : u && (a = h / n), f && (o += h / s), d && (a += h / n);
            var g = fabric.util.transformPoint(new fabric.Point(o, a), r, !0), p = g.x, v = g.y;
            if (this.group && (p *= this.group.scaleX, v *= this.group.scaleY), t.strokeRect(~~(-(p / 2) - e) - .5, ~~(-(v / 2) - e) - .5, ~~(p + i) + 1, ~~(v + i) + 1), this.hasRotatingPoint && this.isControlVisible("mtr") && !this.get("lockRotation") && this.hasControls) {
                var b = (-v - 2 * e) / 2;
                t.beginPath(), t.moveTo(0, b), t.lineTo(0, b - this.rotatingPointOffset), t.closePath(), t.stroke()
            }
            return t.restore(), this
        }, drawControls: function (t) {
            if (!this.hasControls)return this;
            var e = this.cornerSize, i = e / 2, r = this.getViewportTransform(), s = this.strokeWidth > 1 ? this.strokeWidth : 0, n = this.width, o = this.height, a = "round" === this.strokeLineCap || "square" === this.strokeLineCap, h = "line" === this.type && 1 === this.width, c = "line" === this.type && 1 === this.height, l = a && c || "line" !== this.type, u = a && h || "line" !== this.type;
            h ? n = s : c && (o = s), l && (n += s), u && (o += s), n *= this.scaleX, o *= this.scaleY;
            var f = fabric.util.transformPoint(new fabric.Point(n, o), r, !0), d = f.x, g = f.y, p = -(d / 2), v = -(g / 2), b = this.padding, m = i, y = i - e, _ = this.transparentCorners ? "strokeRect" : "fillRect";
            return t.save(), t.lineWidth = 1, t.globalAlpha = this.isMoving ? this.borderOpacityWhenMoving : 1, t.strokeStyle = t.fillStyle = this.cornerColor, this._drawControl("tl", t, _, p - m - b, v - m - b, this.flipX, this.flipY), this._drawControl("tr", t, _, p + d - m + b, v - m - b, this.flipX, this.flipY), this._drawControl("bl", t, _, p - m - b, v + g + y + b, this.flipX, this.flipY), this._drawControl("br", t, _, p + d + y + b, v + g + y + b, this.flipX, this.flipY), this.get("lockUniScaling") || (this._drawControl("mt", t, _, p + d / 2 - m, v - m - b), this._drawControl("mb", t, _, p + d / 2 - m, v + g + y + b), this._drawControl("mr", t, _, p + d + y + b, v + g / 2 - m), this._drawControl("ml", t, _, p - m - b, v + g / 2 - m)), t.restore(), this
        }, _drawControl: function (t, i, r, s, n, o, a) {
            var h = this.cornerSize;
            if (this.isControlVisible(t)) {
                e() || this.transparentCorners || i.clearRect(s, n, h, h);
                var c = new Image, l = "", u = "";
                switch (t) {
                    case"tl":
                        u = a ? "b" : "t", l = o ? "r" : "l";
                    ...
                    case"br":
                        ...
                        break;
                    default:
                        u = t.substr(0, 1), l = t.substr(1, 1)
                }
                switch (t = u + l) {
                    case"mt":
                    case"mb":
                        c.src = "https://o86bsrpha.qnssl.com/assets/fabricjs/icono_escala_vertical-799c843b3a2d60682cd21073d3d9b2d8.png";
                        break;
                    case"ml":
                    case"mr":
                        c.src = "https://o86bsrpha.qnssl.com/assets/fabricjs/icono_escala_horizontal-265ec119ce34d53adcaba0a44e154ba7.png";
                        break;
                    case"tl":
                    case"tr":
                    case"bl":
                    case"br":
                        var f, d = "https://o86bsrpha.qnssl.com/assets/fabricjs/icono_escala_oblicua-8d019020a7c3ee2e9426e5149609ca3c.png", g = "https://o86bsrpha.qnssl.com/assets/fabricjs/icono_rotar-0f28501e52356102fda0a7644930c990.png", p = "https://o86bsrpha.qnssl.com/assets/fabricjs/icono_mover-f26f60f320244d755c62b2e10909083f.png", v = "https://o86bsrpha.qnssl.com/assets/fabricjs/icono_borrar-73c10b8d411b1ce6e94b5bfb440eafe3.png";
                        if (o && !a)switch (t) {
                            case"tl":
                                f = g;
                                break;
    ...
    FX_DURATION: 500, fxCenterObjectH: function (t, e) {
        e = e || {};
        var i = function () {
        }, r = e.onComplete || i, s = e.onChange || i, n = this;
    ...
    animate: function () {
        if (arguments[0] && "object" == typeof arguments[0]) {
            ...
            for (var r = 0, s = i.length; s > r; r++)t = i[r], e = r !== s - 1, this._animate(t, arguments[0][t], arguments[1], e)
    ...
    "use strict";
    function e(t, e) {
        var i = t.origin, r = t.axis1, s = t.axis2, n = t.dimension, o = e.nearest, a = e.center, h = e.farthest;
        return function () {
            switch (this.get(i)) {
                case o:
    ...
    var i = t.fabric || (t.fabric = {}), r = i.util.object.extend, s = {
        x1: 1,
        x2: 1,
        y1: 1,
        y2: 1
    ...
    return i.Line ? void i.warn("fabric.Line is already defined") : (i.Line = i.util.createClass(i.Object, {
        ...
        _render: function (t, e) {
            ...
            if (!this.strokeDashArray || this.strokeDashArray && n) {
                ...
                t.moveTo(1 === this.width ? 0 : r * this.width / 2, 1 === this.height ? 0 : s * this.height / 2), t.lineTo(1 === this.width ? 0 : -1 * r * this.width / 2, 1 === this.height ? 0 : -1 * s * this.height / 2)
            }
            t.lineWidth = this.strokeWidth;
            var o = t.strokeStyle;
            t.strokeStyle = this.stroke || t.fillStyle, this.stroke && this._renderStroke(t), t.strokeStyle = o
        },
        _renderDashedStroke: function (t) {
            var e = this.x1 <= this.x2 ? -1 : 1, r = this.y1 <= this.y2 ? -1 : 1, s = 1 === this.width ? 0 : e * this.width / 2, n = 1 === this.height ? 0 : r * this.height / 2;
            t.beginPath(), i.util.drawDashedLine(t, s, n, -s, -n, this.strokeDashArray), t.closePath()
        },
        toObject: function (t) {
            return r(this.callSuper("toObject", t), this.calcLinePoints())
        },
        calcLinePoints: function () {
            var t = this.x1 <= this.x2 ? -1 : 1, e = this.y1 <= this.y2 ? -1 : 1, i = t * this.width / 2, r = e * this.height / 2, s = -1 * t * this.width / 2, n = -1 * e * this.height / 2;
        ...
        var s = i.parseAttributes(t, i.Line.ATTRIBUTE_NAMES), n = [s.x1 || 0, s.y1 || 0, s.x2 || 0, s.y2 || 0];
    ...
    var i = t.fabric || (t.fabric = {}), r = Math.PI, s = i.util.object.extend;
    return i.Circle ? void i.warn("fabric.Circle is already defined.") : (i.Circle = i.util.createClass(i.Object, {
        ...
        toSVG: function (t) {
            var e = this._createBaseSVGMarkup(), i = 0, s = 0, n = (this.endAngle - this.startAngle) % (2 * r);
            if (0 === n)this.group && "path-group" === this.group.type && (i = this.left + this.radius, s = this.top + this.radius), e.push("<circle ", 'cx="' + i + '" cy="' + s + '" ', 'r="', this.radius, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), " ", this.getSvgTransformMatrix(), '"/>\n'); else {
                var o = Math.cos(this.startAngle) * this.radius, a = Math.sin(this.startAngle) * this.radius, h = Math.cos(this.endAngle) * this.radius, c = Math.sin(this.endAngle) * this.radius, l = n > r ? "1" : "0";
    ...
    return e.Triangle ? void e.warn("fabric.Triangle is already defined") : (e.Triangle = e.util.createClass(e.Object, {
        ...
        toSVG: function (t) {
            var e = this._createBaseSVGMarkup(), i = this.width / 2, r = this.height / 2, s = [-i + " " + r, "0 " + -r, i + " " + r].join(",");
    ...
    r.push("rx", "ry", "x", "y"), e.Rect = e.util.createClass(e.Object, {
        ...
        _renderDashedStroke: function (t) {
            var i = -this.width / 2, r = -this.height / 2, s = this.width, n = this.height;
    ...
    return e.Polygon ? void e.warn("fabric.Polygon is already defined") : (e.Polygon = e.util.createClass(e.Object, {
        ...
        _calcDimensions: function () {
            var t = this.points, e = r(t, "x"), i = r(t, "y"), n = s(t, "x"), o = s(t, "y");
        ...
        commonRender: function (t) {
            ...
            for (var i = 0, r = this.points.length; r > i; i++)e = this.points[i], t.lineTo(e.x, e.y)
        },
        _renderDashedStroke: function (t) {
    ...
    "use strict";
    var e = t.fabric || (t.fabric = {}), i = e.util.array.min, r = e.util.array.max, s = e.util.object.extend, n = Object.prototype.toString, o = e.util.drawArc, a = {
        m: 2,
        l: 2,
        h: 1,
        v: 1,
    ...
    return e.Path ? void e.warn("fabric.Path is already defined") : (e.Path = e.util.createClass(e.Object, {
        ...
        initialize: function (t, e) {
            ...
            if (this.path = i ? t : t.match && t.match(/[mzlhvcsqta][^mzlhvcsqta]*/gi), this.path) {
                ...
                this.minX = r.left, this.minY = r.top, this.width = r.width, this.height = r.height, this.top = this.top || this.minY, this.left = this.left || this.minX, this.pathOffset = this.pathOffset || {
        ...
        _render: function (t) {
            var e, i, r, s, n, a = null, h = 0, c = 0, l = 0, u = 0, f = 0, d = 0, g = -this.pathOffset.x, p = -this.pathOffset.y;
            this.group && "path-group" === this.group.type && (g = 0, p = 0), t.beginPath();
            for (var v = 0, b = this.path.length; b > v; ++v) {
                switch (e = this.path[v], e[0]) {
                    case"l":
                        l += e[1], u += e[2], t.lineTo(l + g, u + p);
                        break;
                    case"L":
                        l = e[1], u = e[2], t.lineTo(l + g, u + p);
                        break;
                    case"h":
                        l += e[1], t.lineTo(l + g, u + p);
                        break;
                    case"H":
                        l = e[1], t.lineTo(l + g, u + p);
                        break;
                    case"v":
                        u += e[1], t.lineTo(l + g, u + p);
                        break;
                    case"V":
                        u = e[1], t.lineTo(l + g, u + p);
                        break;
                    case"m":
                        l += e[1], u += e[2], h = l, c = u, t.moveTo(l + g, u + p);
                        break;
                    case"M":
                        l = e[1], u = e[2], h = l, c = u, t.moveTo(l + g, u + p);
                        break;
                    case"c":
                        i = l + e[5], r = u + e[6], f = l + e[3], d = u + e[4], t.bezierCurveTo(l + e[1] + g, u + e[2] + p, f + g, d + p, i + g, r + p), l = i, u = r;
                        break;
                    case"C":
                        l = e[5], u = e[6], f = e[3], d = e[4], t.bezierCurveTo(e[1] + g, e[2] + p, f + g, d + p, l + g, u + p);
                        break;
                    case"s":
                        i = l + e[3], r = u + e[4], f = f ? 2 * l - f : l, d = d ? 2 * u - d : u, t.bezierCurveTo(f + g, d + p, l + e[1] + g, u + e[2] + p, i + g, r + p), f = l + e[1], d = u + e[2], l = i, u = r;
                        break;
                    case"S":
                        i = e[3], r = e[4], f = 2 * l - f, d = 2 * u - d, t.bezierCurveTo(f + g, d + p, e[1] + g, e[2] + p, i + g, r + p), l = i, u = r, f = e[1], d = e[2];
                        break;
                    case"q":
                        i = l + e[3], r = u + e[4], f = l + e[1], d = u + e[2], t.quadraticCurveTo(f + g, d + p, i + g, r + p), l = i, u = r;
                        break;
                    case"Q":
                        i = e[3], r = e[4], t.quadraticCurveTo(e[1] + g, e[2] + p, i + g, r + p), l = i, u = r, f = e[1], d = e[2];
                        break;
                    case"t":
                        i = l + e[1], r = u + e[2], null === a[0].match(/[QqTt]/) ? (f = l, d = u) : "t" === a[0] ? (f = 2 * l - s, d = 2 * u - n) : "q" === a[0] && (f = 2 * l - f, d = 2 * u - d), s = f, n = d, t.quadraticCurveTo(f + g, d + p, i + g, r + p), l = i, u = r, f = l + e[1], d = u + e[2];
                        break;
                    case"T":
                        i = e[1], r = e[2], f = 2 * l - f, d = 2 * u - d, t.quadraticCurveTo(f + g, d + p, i + g, r + p), l = i, u = r;
                        break;
                    case"a":
                        o(t, l + g, u + p, [e[1], e[2], e[3], e[4], e[5], e[6] + l + g, e[7] + u + p]), l += e[6], u += e[7];
                        break;
                    case"A":
                        o(t, l + g, u + p, [e[1], e[2], e[3], e[4], e[5], e[6] + g, e[7] + p]), l = e[6], u = e[7];
                        break;
                    case"z":
                    case"Z":
                        l = h, u = c, t.closePath()
        ...
        _parsePath: function () {
            for (var t, e, i, r, s, n = [], o = [], c = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi, l = 0, u = this.path.length; u > l; l++) {
                ...
                if (s.length - 1 > p)for (var b = 1, m = s.length; m > b; b += p)n.push([g].concat(s.slice(b, b + p))), g = v; else n.push(s)
            }
            return n
        },
        _parseDimensions: function () {
            for (var t, s, n, o, a, h, c = [], l = [], u = null, f = 0, d = 0, g = 0, p = 0, v = 0, b = 0, m = 0, y = this.path.length; y > m; ++m) {
                switch (t = this.path[m], t[0]) {
                    ...
                    case"V":
                        ...
                        break;
                    case"m":
                        g += t[1], p += t[2], f = g, d = p, h = [];
                        break;
                    case"M":
                        g = t[1], p = t[2], f = g, d = p, h = [];
                        break;
                    case"c":
                        s = g + t[5], n = p + t[6], v = g + t[3], b = p + t[4], h = e.util.getBoundsOfCurve(g, p, g + t[1], p + t[2], v, b, s, n), g = s, p = n;
                        break;
                    case"C":
                        g = t[5], p = t[6], v = t[3], b = t[4], h = e.util.getBoundsOfCurve(g, p, t[1], t[2], v, b, g, p);
                        break;
                    case"s":
                        s = g + t[3], n = p + t[4], v = v ? 2 * g - v : g, b = b ? 2 * p - b : p, h = e.util.getBoundsOfCurve(g, p, v, b, g + t[1], p + t[2], s, n), v = g + t[1], b = p + t[2], g = s, p = n;
                        break;
                    case"S":
                        s = t[3], n = t[4], v = 2 * g - v, b = 2 * p - b, h = e.util.getBoundsOfCurve(g, p, v, b, t[1], t[2], s, n), g = s, p = n, v = t[1], b = t[2];
                        break;
                    case"q":
                        s = g + t[3], n = p + t[4], v = g + t[1], b = p + t[2], h = e.util.getBoundsOfCurve(g, p, v, b, v, b, s, n), g = s, p = n;
                        break;
                    case"Q":
                        v = t[1], b = t[2], h = e.util.getBoundsOfCurve(g, p, v, b, v, b, t[3], t[4]), g = t[3], p = t[4];
                        break;
                    case"t":
                        s = g + t[1], n = p + t[2], null === u[0].match(/[QqTt]/) ? (v = g, b = p) : "t" === u[0] ? (v = 2 * g - o, b = 2 * p - a) : "q" === u[0] && (v = 2 * g - v, b = 2 * p - b), o = v, a = b, h = e.util.getBoundsOfCurve(g, p, v, b, v, b, s, n), g = s, p = n, v = g + t[1], b = p + t[2];
                        break;
                    case"T":
                        s = t[1], n = t[2], v = 2 * g - v, b = 2 * p - b, h = e.util.getBoundsOfCurve(g, p, v, b, v, b, s, n), g = s, p = n;
                        break;
                    case"a":
                        h = e.util.getBoundsOfArc(g, p, t[1], t[2], t[3], t[4], t[5], t[6] + g, t[7] + p), g += t[6], p += t[7];
                        break;
                    case"A":
                        h = e.util.getBoundsOfArc(g, p, t[1], t[2], t[3], t[4], t[5], t[6], t[7]), g = t[6], p = t[7];
                        break;
                    case"z":
                    case"Z":
                        g = f, p = d
                }
                u = t, h.forEach(function (t) {
                    c.push(t.x), l.push(t.y)
                }), c.push(g), l.push(p)
            }
            var _ = i(c), x = i(l), C = r(c), S = r(l), w = C - _, O = S - x, T = {
                left: _,
                top: x,
                width: w,
                height: O
    ...
    if (!e.Group) {
        ...
        e.Group = e.util.createClass(e.Object, e.Collection, {
            ...
            initialize: function (t, e) {
                ...
                this.originalState = {}, this.callSuper("initialize"), this._calcBounds(), this._updateObjectsCoords(), e && i(this, e), this.setCoords(), this.saveCoords()
            },
            _updateObjectsCoords: function () {
                this.forEachObject(this._updateObjectCoords, this)
            },
            _updateObjectCoords: function (t) {
                var e = t.getLeft(), i = t.getTop();
                t.set({
                    originalLeft: e,
                    originalTop: i,
                    left: e - this.left,
            ...
            _moveFlippedObject: function (t) {
                var e = t.get("originX"), i = t.get("originY"), r = t.getCenterPoint();
            ...
            _setObjectPosition: function (t) {
                var e = this.getLeft(), i = this.getTop(), r = this._getRotatedLeftTop(t);
                t.set({
            ...
            _getBounds: function (t, i, n) {
                var o = e.util.invertTransform(this.getViewportTransform()), a = e.util.transformPoint(new e.Point(r(t), r(i)), o), h = e.util.transformPoint(new e.Point(s(t), s(i)), o), c = {
                    width: h.x - a.x || 0,
                    height: h.y - a.y || 0
                };
                return n || (c.left = (a.x + h.x) / 2 || 0, c.top = (a.y + h.y) / 2 || 0), c
            },
            toSVG: function (t) {
    ...
    return t.fabric || (t.fabric = {}), t.fabric.Image ? void fabric.warn("fabric.Image is already defined.") : (fabric.Image = fabric.util.createClass(fabric.Object, {
        ...
        _renderDashedStroke: function (t) {
            var e = -this.width / 2, i = -this.height / 2, r = this.width, s = this.height;
        ...
        applyFilters: function (t) {
            if (this._originalElement) {
                ...
                var e = this._originalElement, i = fabric.util.createCanvasElement(), r = fabric.util.createImage(), s = this;
                return i.width = e.width, i.height = e.height, i.getContext("2d").drawImage(e, 0, 0, e.width, e.height), this.filters.forEach(function (t) {
                    t && t.applyTo(i)
                }), r.width = e.width, r.height = e.height, fabric.isLikelyNode ? (r.src = i.toBuffer(void 0, fabric.Image.pngCompression), s._element = r, t && t()) : (r.onload = function () {
                    s._element = r, t && t(), r.onload = i = e = null
        ...
        var s = fabric.parseAttributes(t, fabric.Image.ATTRIBUTE_NAMES);
    ...
    _getAngleValueForStraighten: function () {
        ...
        t = t || {};
        var e = function () {
        }, i = t.onComplete || e, r = t.onChange || e, s = this;
        return fabric.util.animate({
    ...
    type: "BaseFilter", toObject: function () {
    ...
    e.Image.filters.Convolute = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        applyTo: function (t) {
            for (var e = this.matrix, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), s = Math.round(Math.sqrt(e.length)), n = Math.floor(s / 2), o = r.data, a = r.width, h = r.height, c = a, l = h, u = this._createImageData(c, l), f = u.data, d = this.opaque ? 1 : 0, g = 0; l > g; g++)for (var p = 0; c > p; p++) {
                for (var v = g, b = p, m = 4 * (g * c + p), y = 0, _ = 0, x = 0, C = 0, S = 0; s > S; S++)for (var w = 0; s > w; w++) {
                    var O = v + S - n, T = b + w - n;
                    if (!(0 > O || O > h || 0 > T || T > a)) {
                        var k = 4 * (O * a + T), j = e[S * s + w];
    ...
    e.Image.filters.Invert = e.util.createClass(e.Image.filters.BaseFilter, {
        type: "Invert", applyTo: function (t) {
            var e, i = t.getContext("2d"), r = i.getImageData(0, 0, t.width, t.height), s = r.data, n = s.length;
    ...
    e.Image.filters.Mask = e.util.createClass(e.Image.filters.BaseFilter, {
        type: "Mask", initialize: function (t) {
            ...
            if (this.mask) {
                var i, r = t.getContext("2d"), s = r.getImageData(0, 0, t.width, t.height), n = s.data, o = this.mask.getElement(), a = e.util.createCanvasElement(), h = this.channel, c = s.width * s.height * 4;
    ...
    e.Image.filters.Pixelate = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        applyTo: function (t) {
            var e, i, r, s, n, o, a, h = t.getContext("2d"), c = h.getImageData(0, 0, t.width, t.height), l = c.data, u = c.height, f = c.width;
            for (i = 0; u > i; i += this.blocksize)for (r = 0; f > r; r += this.blocksize) {
                e = 4 * i * f + 4 * r, s = l[e], n = l[e + 1], o = l[e + 2], a = l[e + 3];
                for (var d = i, g = i + this.blocksize; g > d; d++)for (var p = r, v = r + this.blocksize; v > p; p++)e = 4 * d * f + 4 * p, l[e] = s, l[e + 1] = n, l[e + 2] = o, l[e + 3] = a
            }
    ...
    e.Image.filters.Sepia = e.util.createClass(e.Image.filters.BaseFilter, {
        type: "Sepia", applyTo: function (t) {
            var e, i, r = t.getContext("2d"), s = r.getImageData(0, 0, t.width, t.height), n = s.data, o = n.length;
    ...
    e.Image.filters.Sepia2 = e.util.createClass(e.Image.filters.BaseFilter, {
        type: "Sepia2", applyTo: function (t) {
            var e, i, r, s, n = t.getContext("2d"), o = n.getImageData(0, 0, t.width, t.height), a = o.data, h = a.length;
    ...
    e.Image.filters.Tint = e.util.createClass(e.Image.filters.BaseFilter, {
        type: "Tint", initialize: function (t) {
            ...
            var i, r, s, n, o, a, h, c, l, u = t.getContext("2d"), f = u.getImageData(0, 0, t.width, t.height), d = f.data, g = d.length;
    ...
    e.Image.filters.Multiply = e.util.createClass(e.Image.filters.BaseFilter, {
        ...
        applyTo: function (t) {
            var i, r, s = t.getContext("2d"), n = s.getImageData(0, 0, t.width, t.height), o = n.data, a = o.length;
    ...
    e.Image.filters.Blend = e.util.createClass({
        type: "Blend", initialize: function (t) {
            ...
            var i, r, s, n, o, a, h, c = t.getContext("2d"), l = c.getImageData(0, 0, t.width, t.height), u = l.data, f = !1;
            if (this.image) {
                f = !0;
            ...
            for (var v = 0, b = u.length; b > v; v += 4)switch (n = u[v], o = u[v + 1], a = u[v + 2], f && (i = h[v] * this.alpha, r = h[v + 1] * this.alpha, s = h[v + 2] * this.alpha), this.mode) {
                case"multiply":
                ...
                case"difference":
                    ...
                    break;
                case"subtract":
                    var m = n - i, y = o - r, _ = a - s;
                    u[v] = 0 > m ? 0 : m, u[v + 1] = 0 > y ? 0 : y, u[v + 2] = 0 > _ ? 0 : _;
                    break;
                case"darken":
    ...
    o.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor", "useNative", "path"), e.Text = e.util.createClass(e.Object, {
        ...
        _renderText: function (t, e) {
            t.save(), this._setShadow(t), this._setupCompositeOperation(t), this._renderTextFill(t, e), this._renderTextStroke(t, e), this._restoreCompositeOperation(t), this._removeShadow(t), t.restore()
        },
        ...
        _setBoundaries: function (t, e) {
            ...
            for (var i = 0, r = e.length; r > i; i++) {
                var s = this._getLineWidth(t, e[i]), n = this._getLineLeftOffset(s);
        ...
        _getTextWidth: function (t, e) {
            for (var i = t.measureText(e[0] || "|").width, r = 1, s = e.length; s > r; r++) {
        ...
        _renderTextLine: function (t, e, i, r, s, n) {
            ...
            var o = e.measureText(i).width, a = this.width;
            if (a > o)for (var h = i.split(/\s+/), c = e.measureText(i.replace(/\s+/g, "")).width, l = a - c, u = h.length - 1, f = l / u, d = 0, g = 0, p = h.length; p > g; g++)this._renderChars(t, e, h[g], r + d, s, n), d += e.measureText(h[g]).width + f; else this._renderChars(t, e, i, r, s, n)
        },
        ...
        _renderTextFill: function (t, e) {
            if (this.fill || this._skipFillStrokeCheck) {
                this._boundaries = [];
                for (var i = 0, r = 0, s = e.length; s > r; r++) {
        ...
        _renderTextLinesBackground: function (t, e) {
            if (this.textBackgroundColor) {
                ...
                for (var i = 0, r = e.length; r > i; i++)if ("" !== e[i]) {
                    var s = this._getLineWidth(t, e[i]), n = this._getLineLeftOffset(s);
        ...
        _renderTextDecoration: function (t, e) {
            function i(i) {
                for (var n = 0, o = e.length; o > n; n++) {
                    var a = s._getLineWidth(t, e[n]), h = s._getLineLeftOffset(a);
                    t.fillRect(s._getLeftOffset() + h, ~~(i + n * s._getHeightOfLine(t, n, e) - r), a, 1)
                }
            }

            if (this.textDecoration) {
                var r = this._getTextHeight(t, e) / 2, s = this;
        ...
        toSVG: function (t) {
            var e = [], i = this.text.split(this._reNewline), r = this._getSVGLeftTopOffsets(i), s = this._getSVGTextAndBg(r.lineTop, r.textLeft, i), n = this._getSVGShadows(r.lineTop, i);
        ...
        _getSVGLeftTopOffsets: function (t) {
            var e = this.useNative ? this.fontSize * this.lineHeight : -this._fontAscent - this._fontAscent / 5 * this.lineHeight, i = -(this.width / 2), r = this.useNative ? this.fontSize - 1 : this.height / 2 - t.length * this.fontSize - this._totalLineHeight;
            return {
        ...
        _getSVGShadows: function (t, i) {
            ...
            for (r = 0, n = i.length; n > r; r++)if ("" !== i[r]) {
                var h = this._boundaries && this._boundaries[r] ? this._boundaries[r].left : 0;
                o.push('<tspan x="', s(h + a + this.shadow.offsetX, 2), 0 === r || this.useNative ? '" y' : '" dy', '="', s(this.useNative ? t * r - this.height / 2 + this.shadow.offsetY : t + (0 === r ? this.shadow.offsetY : 0), 2), '" ', this._getFillAttributes(this.shadow.color), ">", e.util.string.escapeXml(i[r]), "</tspan>"), a = 1
            } else a++;
            return o
        },
        _getSVGTextAndBg: function (t, e, i) {
            var r = [], s = [], n = 1;
            this._setSVGBg(s);
            for (var o = 0, a = i.length; a > o; o++)"" !== i[o] ? (this._setSVGTextLineText(i[o], o, r, t, n, s), n = 1) : n++, this.textBackgroundColor && this._boundaries && this._setSVGTextLineBg(s, o, e, t);
        ...
        _setSVGTextLineBg: function (t, e, i, r) {
            t.push("<rect ", this._getFillAttributes(this.textBackgroundColor), ' x="', s(i + this._boundaries[e].left, 2), '" y="', s(r * e - this.height / 2, 2), '" width="', s(this._boundaries[e].width, 2), '" height="', s(this._boundaries[e].height, 2), '"></rect>\n')
        },
        _setSVGBg: function (t) {
            this.backgroundColor && this._boundaries && t.push("<rect ", this._getFillAttributes(this.backgroundColor), ' x="', s(-this.width / 2, 2), '" y="', s(-this.height / 2, 2), '" width="', s(this.width, 2), '" height="', s(this.height, 2), '"></rect>')
        },
        ...
        var s = new e.Text(t.textContent, i), n = 0;
        return "left" === s.originX && (n = s.getWidth() / 2), "right" === s.originX && (n = -s.getWidth() / 2), s.set({
            left: s.getLeft() + n,
            top: s.getTop() - s.getHeight() / 2
        }), s
    ...
    fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
        ...
        setSelectionStart: function (t) {
            this.selectionStart !== t && (this.fire("selection:changed"), this.canvas && this.canvas.fire("text:selection:changed", {target: this})), this.selectionStart = t, this.hiddenTextarea && (this.hiddenTextarea.selectionStart = t)
        },
        setSelectionEnd: function (t) {
            this.selectionEnd !== t && (this.fire("selection:changed"), this.canvas && this.canvas.fire("text:selection:changed", {target: this})), this.selectionEnd = t, this.hiddenTextarea && (this.hiddenTextarea.selectionEnd = t)
        },
        ...
        get2DCursorLocation: function (t) {
            ...
            var e = this.text.slice(0, t), i = e.split(this._reNewline);
        ...
        _getCursorBoundaries: function (t, e) {
            var i = this.get2DCursorLocation(), r = this.text.split(this._reNewline), s = Math.round(this._getLeftOffset()), n = this._getTopOffset(), o = this._getCursorBoundariesOffsets(t, e, i, r);
        ...
        renderCursor: function (t) {
            var e = this.ctx;
            e.save();
            var i = this.get2DCursorLocation(), r = i.lineIndex, s = i.charIndex, n = this.getCurrentCharFontSize(r, s), o = 0 === r && 0 === s ? this._getCachedLineOffset(r, this.text.split(this._reNewline)) : t.leftOffset;
        ...
        renderSelection: function (t, e) {
            ...
            for (var r = this.get2DCursorLocation(this.selectionStart), s = this.get2DCursorLocation(this.selectionEnd), n = r.lineIndex, o = s.lineIndex, a = this.text.split(this._reNewline), h = n; o >= h; h++) {
                var c = this._getCachedLineOffset(h, a) || 0, l = this._getCachedLineHeight(h), u = 0;
                if (h === n)for (var f = 0, d = a[h].length; d > f; f++)f >= r.charIndex && (h !== o || f < s.charIndex) && (u += this._getWidthOfChar(i, a[h][f], h, f)), f < r.charIndex && (c += this._getWidthOfChar(i, a[h][f], h, f)); else if (h > n && o > h)u += this._getCachedLineWidth(h, a) || 5; else if (h === o)for (var g = 0, p = s.charIndex; p > g; g++)u += this._getWidthOfChar(i, a[h][g], h, g);
        ...
        _renderChars: function (t, e, i, r, s, n) {
            ...
            var o, a = this.text.split(this._reNewline), h = this._getWidthOfLine(e, n, a), c = this._getHeightOfLine(e, n, a), l = this._getLineLeftOffset(h), u = i.split(""), f = "";
            r += l || 0, e.save();
            for (var d = 0, g = u.length; g >= d; d++) {
        ...
        _renderChar: function (t, e, i, r, s, n, o, a) {
            ...
            if (this.styles && this.styles[i] && (h = this.styles[i][r])) {
                var u = h.stroke || this.stroke, f = h.fill || this.fill;
                e.save(), c = this._applyCharStylesGetWidth(e, s, i, r, h), l = this._getHeightOfChar(e, s, i, r), f && e.fillText(s, n, o), u && e.strokeText(s, n, o), this._renderCharDecoration(e, h, n, o, c, a, l), e.restore(), e.translate(c, 0)
            } else"strokeText" === t && this.stroke && e[t](s, n, o), "fillText" === t && this.fill && e[t](s, n, o), c = this._applyCharStylesGetWidth(e, s, i, r), this._renderCharDecoration(e, null, n, o, c, a), e.translate(e.measureText(s).width, 0)
        },
        ...
        _renderCharDecoration: function (t, e, i, r, s, n, o) {
            var a = e ? e.textDecoration || this.textDecoration : this.textDecoration, h = (e ? e.fontSize : null) || this.fontSize;
            a && (a.indexOf("underline") > -1 && this._renderCharDecorationAtOffset(t, i, r + this.fontSize / this._fontSizeFraction, s, 0, this.fontSize / 20), a.indexOf("line-through") > -1 && this._renderCharDecorationAtOffset(t, i, r + this.fontSize / this._fontSizeFraction, s, o / 2, h / 20), a.indexOf("overline") > -1 && this._renderCharDecorationAtOffset(t, i, r, s, n - this.fontSize / this._fontSizeFraction, this.fontSize / 20))
        },
        ...
        _renderTextDecoration: function (t, e) {
            return this.isEmptyStyles() ? this.callSuper("_renderTextDecoration", t, e) : void 0
        },
        _renderTextLinesBackground: function (t, e) {
            if (this.textBackgroundColor || this.styles) {
                t.save(), this.textBackgroundColor && (t.fillStyle = this.textBackgroundColor);
                for (var i = 0, r = this.fontSize / this._fontSizeFraction, s = 0, n = e.length; n > s; s++) {
                    var o = this._getHeightOfLine(t, s, e);
                    if ("" !== e[s]) {
                        var a = this._getWidthOfLine(t, s, e), h = this._getLineLeftOffset(a);
                        if (this.textBackgroundColor && (t.fillStyle = this.textBackgroundColor, t.fillRect(this._getLeftOffset() + h, this._getTopOffset() + i + r, a, o)), this.styles[s])for (var c = 0, l = e[s].length; l > c; c++)if (this.styles[s] && this.styles[s][c] && this.styles[s][c].textBackgroundColor) {
                            var u = e[s][c];
                            t.fillStyle = this.styles[s][c].textBackgroundColor, t.fillRect(this._getLeftOffset() + h + this._getWidthOfCharsAt(t, s, c, e), this._getTopOffset() + i + r, this._getWidthOfChar(t, u, s, c, e) + 1, o)
                        }
                        i += o
                    } else i += o
                }
        ...
        _getWidthOfCharsAt: function (t, e, i, r) {
            for (var s = 0, n = 0; i > n; n++)s += this._getWidthOfCharAt(t, e, n, r);
            return s
        },
        ...
        _getWidthOfSpace: function (t, e) {
            var i = this.text.split(this._reNewline), r = i[e], s = r.split(/\s+/), n = this._getWidthOfWords(t, r, e), o = this.width - n, a = s.length - 1, h = o / a;
            return h
        },
        ...
        _getTextWidth: function (t, e) {
            ...
            for (var i = this._getWidthOfLine(t, 0, e), r = 1, s = e.length; s > r; r++) {
        ...
        _getHeightOfLine: function (t, e, i) {
            ...
            for (var r = this._getHeightOfChar(t, i[e][0], e, 0), s = i[e], n = s.split(""), o = 1, a = n.length; a > o; o++) {
        ...
        _getTextHeight: function (t, e) {
            for (var i = 0, r = 0, s = e.length; s > r; r++)i += this._getHeightOfLine(t, r, e);
            return i
        },
        _getTopOffset: function () {
        ...
        initBehavior: function () {
            ...
            if (!this._abortCursorAnimation) {
                ...
                this.animate("_currentCursorOpacity", 1, {
                    duration: this.cursorDuration, onComplete: function () {
                        t._onTickComplete()
                    }, onChange: function () {
            ...
            if (!this._abortCursorAnimation) {
                ...
                this._cursorTimeout1 && clearTimeout(this._cursorTimeout1), this._cursorTimeout1 = setTimeout(function () {
                    t.animate("_currentCursorOpacity", 0, {
                        duration: this.cursorDuration / 2, onComplete: function () {
                            t._tick()
                        }, onChange: function () {
                            t.canvas && t.canvas.renderAll()
                        }, abort: function () {
            ...
            for (var t = this.getSelectedText(), e = 0, i = 0, r = t.split(""), s = r.length; s > i; i++)"\n" === r[i] && e++;
            return e
            ...
            for (var i = e; i !== t;) {
                ...
                i--;
                var s = this.get2DCursorLocation(i).charIndex, n = s > r;
            ...
            this.text = this.text.slice(0, this.selectionStart) + t + this.text.slice(this.selectionEnd), this.selectionStart === this.selectionEnd && this.insertStyleObjects(t, e, this.copiedStyles), this.selectionStart += t.length, this.selectionEnd = this.selectionStart, this.canvas && this.canvas.renderAll().renderAll(), this.setCoords(), this.fire("changed"), this.canvas && this.canvas.fire("text:changed", {target: this})
        }, insertNewlineStyleObject: function (e, i, r) {
            this.shiftLineStyles(e, 1), this.styles[e + 1] || (this.styles[e + 1] = {});
            var s = this.styles[e][i - 1], n = {};
            if (r)n[0] = t(s), this.styles[e + 1] = n; else {
            ...
            if (!this.isEmptyStyles()) {
                var r = this.get2DCursorLocation(), s = r.lineIndex, n = r.charIndex;
            ...
            for (var e = 0, i = t.length; i > e; e++) {
                var r = this.get2DCursorLocation(this.selectionStart + e), s = r.lineIndex, n = r.charIndex;
            ...
            var r = this.get2DCursorLocation(i), s = r.lineIndex, n = r.charIndex;
            if (e) {
                var o = this.text.split(this._reNewline), a = o[s - 1], h = a ? a.length : 0;
    ...
    initDoubleClickSimulation: function () {
        ...
        var e = this.canvas.getPointer(t), i = new fabric.Point(e.x, e.y), r = new fabric.Point(this.left, this.top), s = fabric.util.rotatePoint(i, r, fabric.util.degreesToRadians(-this.angle));
        return this.getLocalPointer(t, s)
    }, getSelectionStartFromPointer: function (t) {
        for (var e, i = this._getLocalRotatedPointer(t), r = this.text.split(this._reNewline), s = 0, n = 0, o = 0, a = 0, h = 0, c = r.length; c > h; h++) {
            o += this._getHeightOfLine(this.ctx, h) * this.scaleY;
            var l = this._getWidthOfLine(this.ctx, h, r), u = this._getLineLeftOffset(l);
            n = u * this.scaleX, this.flipX && (r[h] = r[h].split("").reverse().join(""));
            for (var f = 0, d = r[h].length; d > f; f++) {
                var g = r[h][f];
        ...
        var n = t.x - e, o = i - t.x, a = o > n ? 0 : 1, h = r + a;
    ...
    paste: function (t) {
        var e = null, i = this._getClipboardData(t);
    ...
    getDownCursorOffset: function (t, e) {
        var i, r, s = e ? this.selectionEnd : this.selectionStart, n = this.text.split(this._reNewline), o = this.text.slice(0, s), a = this.text.slice(s), h = o.slice(o.lastIndexOf("\n") + 1), c = a.match(/(.*)\n?/)[1], l = (a.match(/.*\n(.*)\n?/) || {})[1] || "", u = this.get2DCursorLocation(s);
        ...
        for (var d = r, g = u.lineIndex, p = 0, v = h.length; v > p; p++)i = h[p], d += this._getWidthOfChar(this.ctx, i, g, p);
        var b = this._getIndexOnNextLine(u, l, d, n);
        return c.length + 1 + b
    },
    _getIndexOnNextLine: function (t, e, i, r) {
        for (var s, n = t.lineIndex + 1, o = this._getWidthOfLine(this.ctx, n, r), a = this._getLineLeftOffset(o), h = a, c = 0, l = 0, u = e.length; u > l; l++) {
            var f = e[l], d = this._getWidthOfChar(this.ctx, f, n, l);
            if (h += d, h > i) {
                s = !0;
                var g = h - d, p = h, v = Math.abs(g - i), b = Math.abs(p - i);
                c = v > b ? l + 1 : l;
                break
            }
        }
    ...
    moveCursorDownWithoutShift: function (t) {
        this._selectionDirection = "right", this.selectionStart += t, this.selectionStart > this.text.length && (this.selectionStart = this.text.length), this.selectionEnd = this.selectionStart
    },
    ...
    moveCursorDownWithShift: function (t) {
        ...
        this[e] += t, this.selectionEnd < this.selectionStart && "left" === this._selectionDirection && (this.swapSelectionPoints(), this._selectionDirection = "right"), this.selectionEnd > this.text.length && (this.selectionEnd = this.text.length)
    },
    getUpCursorOffset: function (t, e) {
        var i = e ? this.selectionEnd : this.selectionStart, r = this.get2DCursorLocation(i);
        if (0 === r.lineIndex || t.metaKey || 33 === t.keyCode)return i;
        for (var s, n = this.text.slice(0, i), o = n.slice(n.lastIndexOf("\n") + 1), a = (n.match(/\n?(.*)\n.*$/) || {})[1] || "", h = this.text.split(this._reNewline), c = this._getWidthOfLine(this.ctx, r.lineIndex, h), l = this._getLineLeftOffset(c), u = l, f = r.lineIndex, d = 0, g = o.length; g > d; d++)s = o[d], u += this._getWidthOfChar(this.ctx, s, f, d);
    ...
    moveCursorUpWithShift: function (t) {
        ...
        var e = "right" === this._selectionDirection ? "selectionEnd" : "selectionStart";
        this[e] -= t, this.selectionEnd < this.selectionStart && "right" === this._selectionDirection && (this.swapSelectionPoints(), this._selectionDirection = "left"), this.selectionStart < 0 && (this.selectionStart = 0)
    },
    moveCursorUpWithoutShift: function (t) {
        this.selectionStart === this.selectionEnd && (this.selectionStart -= t), this.selectionStart < 0 && (this.selectionStart = 0), this.selectionEnd = this.selectionStart, this._selectionDirection = "left"
    },
    ...
    moveCursorLeftWithoutShift: function (t) {
        this._selectionDirection = "left", this.selectionEnd === this.selectionStart && this._moveLeft(t, "selectionStart"), this.selectionEnd = this.selectionStart
    },
    ...
    moveCursorRightWithoutShift: function (t) {
        this._selectionDirection = "right", this.selectionStart === this.selectionEnd ? (this._moveRight(t, "selectionStart"), this.selectionEnd = this.selectionStart) : (this.selectionEnd += this.getNumNewLinesInSelectedText(), this.selectionEnd > this.text.length && (this.selectionEnd = this.text.length), this.selectionStart = this.selectionEnd)
    },
    removeChars: function (t) {
        this.selectionStart === this.selectionEnd ? this._removeCharsNearCursor(t) : this._removeCharsFromTo(this.selectionStart, this.selectionEnd), this.selectionEnd = this.selectionStart, this._removeExtraneousStyles(), this.canvas && this.canvas.renderAll().renderAll(), this.setCoords(), this.fire("changed"), this.canvas && this.canvas.fire("text:changed", {target: this})
    },
    ...
    _setSVGTextLineText: function (t, e, i, r, s, n) {
        ...
        for (var o = 0 === e || this.useNative ? "y" : "dy", a = t.split(""), h = 0, c = this._getSVGLineLeftOffset(e), l = this._getSVGLineTopOffset(e), u = this._getHeightOfLine(this.ctx, e), f = 0, d = a.length; d > f; f++) {
        ...
        for (var e = 0, i = 0; t >= i; i++)e += this._getHeightOfLine(this.ctx, i);
        ...
        return ['<tspan x="', i + n, '" ', s, '="', r, '" ', e.fontFamily ? 'font-family="' + e.fontFamily.replace(/"/g, "'") + '" ' : "", e.fontSize ? 'font-size="' + e.fontSize + '" ' : "", e.fontStyle ? 'font-style="' + e.fontStyle + '" ' : "", e.fontWeight ? 'font-weight="' + e.fontWeight + '" ' : "", e.textDecoration ? 'text-decoration="' + e.textDecoration + '" ' : "", 'style="', o, '">', fabric.util.string.escapeXml(t), "</tspan>"].join("")
    }
}), function () {
    function request(t, e, i) {
        var r = URL.parse(t);
        r.port || (r.port = 0 === r.protocol.indexOf("https:") ? 443 : 80);
        var s = 443 === r.port ? HTTPS : HTTP, n = s.request({
            hostname: r.hostname,
            port: r.port,
            path: r.path,
            method: "GET"
        ...
        n.on("error", function (t) {
            fabric.log(t.errno === process.ECONNREFUSED ? "ECONNREFUSED: connection refused to " + r.hostname + ":" + r.port : t.message)
        }), n.end()
    }
    ...
    "use strict";
    var e = t.fabric || (t.fabric = {}), i = e.util.object.extend, r = e.util.object.clone;
    if (e.CurvedText)return void e.warn("fabric.CurvedText is already defined");
    var s = e.Text.prototype.stateProperties.concat();
    s.push("radius", "spacing", "reverse", "effect", "range", "largeFont", "smallFont");
    var n = e.Text.prototype._dimensionAffectingProps;
    n.radius = !0, n.spacing = !0, n.reverse = !0, n.fill = !0, n.effect = !0, n.width = !0, n.height = !0, n.range = !0, n.fontSize = !0, n.shadow = !0, n.largeFont = !0, n.smallFont = !0;
    var o = e.Group.prototype.delegatedProperties;
    o.backgroundColor = !0, o.textBackgroundColor = !0, o.textDecoration = !0, o.stroke = !0, o.strokeWidth = !0, o.shadow = !0, e.CurvedText = e.util.createClass(e.Text, e.Collection, {
        type: "curvedText",
        radius: 50,
        range: 5,
        smallFont: 10,
        ...
        reverse: !1,
        stateProperties: s,
        delegatedProperties: o,
        _dimensionAffectingProps: n,
        _isRendering: 0,
        complexity: function () {
            this.callSuper("complexity")
        },
        initialize: function (t, i) {
            i || (i = {}), this.letters = new e.Group([], {
                selectable: !1,
                padding: 0
            }), this.__skipDimension = !0, this.setOptions(i), this.__skipDimension = !1, this.setText(t)
        },
        setText: function (t) {
            if (this.letters) {
                for (; 0 !== t.length && this.letters.size() >= t.length;)this.letters.remove(this.letters.item(this.letters.size() - 1));
                for (var i = 0; i < t.length; i++)void 0 === this.letters.item(i) ? this.letters.add(new e.Text(t[i])) : this.letters.item(i).setText(t[i])
            }
            this.callSuper("setText", t)
        },
        _render: function () {
            var t = e.util.getRandomInt(100, 999);
            if (this._isRendering = t, this.letters) {
                var i = 0, r = 0, s = 0, n = 0, o = parseInt(this.spacing), a = 0;
                if ("curved" == this.effect) {
                    for (var h = 0, c = this.text.length; c > h; h++)n += this.letters.item(h).width + o;
                    n -= o
                } else"arc" == this.effect && (a = (this.letters.item(0).fontSize + o) / this.radius / (Math.PI / 180), n = (this.text.length + 1) * (this.letters.item(0).fontSize + o));
                i = "right" === this.get("textAlign") ? 90 - n / 2 / this.radius / (Math.PI / 180) : "left" === this.get("textAlign") ? -90 - n / 2 / this.radius / (Math.PI / 180) : -(n / 2 / this.radius / (Math.PI / 180)), this.reverse && (i = -i);
                for (var l = 0, u = this.reverse ? -1 : 1, f = 0, d = 0, h = 0, c = this.text.length; c > h; h++) {
                    if (t !== this._isRendering)return;
                    for (var g in this.delegatedProperties)this.letters.item(h).set(g, this.get(g));
                    if (this.letters.item(h).set("left", l), this.letters.item(h).set("top", 0), this.letters.item(h).setAngle(0), this.letters.item(h).set("padding", 0), "curved" === this.effect)f = (this.letters.item(h).width + o) / this.radius / (Math.PI / 180), r = u * (u * i + d + f / 2), i = u * (u * i + d), s = i * (Math.PI / 180), d = f, this.letters.item(h).setAngle(r), this.letters.item(h).set("top", -1 * u * Math.cos(s) * this.radius), this.letters.item(h).set("left", u * Math.sin(s) * this.radius), this.letters.item(h).set("padding", 0), this.letters.item(h).set("selectable", !1); else if ("arc" === this.effect)i = u * (u * i + a), s = i * (Math.PI / 180), this.letters.item(h).set("top", -1 * u * Math.cos(s) * this.radius), this.letters.item(h).set("left", u * Math.sin(s) * this.radius), this.letters.item(h).set("padding", 0), this.letters.item(h).set("selectable", !1); else if ("STRAIGHT" === this.effect)this.letters.item(h).set("left", l), this.letters.item(h).set("top", 0), this.letters.item(h).setAngle(0), l += this.letters.item(h).get("width"), this.letters.item(h).set("padding", 0), this.letters.item(h).set({
                        borderColor: "red",
                        cornerColor: "green",
                        cornerSize: 6,
                        transparentCorners: !1
                    }), this.letters.item(h).set("selectable", !1); else if ("smallToLarge" === this.effect) {
                        var p = parseInt(this.smallFont), v = parseInt(this.largeFont), b = v - p, m = Math.ceil(this.text.length / 2), y = b / this.text.length, _ = p + h * y;
                        this.letters.item(h).set("fontSize", _), this.letters.item(h).set("left", l), l += this.letters.item(h).get("width"), this.letters.item(h).set("padding", 0), this.letters.item(h).set("selectable", !1), this.letters.item(h).set("top", -1 * this.letters.item(h).get("fontSize") + h)
                    } else if ("largeToSmallTop" === this.effect) {
                        var p = parseInt(this.largeFont), v = parseInt(this.smallFont), b = v - p, m = Math.ceil(this.text.length / 2), y = b / this.text.length, _ = p + h * y;
                        this.letters.item(h).set("fontSize", _), this.letters.item(h).set("left", l), l += this.letters.item(h).get("width"), this.letters.item(h).set("padding", 0), this.letters.item(h).set({
                            borderColor: "red",
                            cornerColor: "green",
                            cornerSize: 6,
                            transparentCorners: !1
                        }), this.letters.item(h).set("padding", 0), this.letters.item(h).set("selectable", !1), this.letters.item(h).top = -1 * this.letters.item(h).get("fontSize") + h / this.text.length
                        ...
                        this.letters.item(h).set("fontSize", _), this.letters.item(h).set("left", l), l += this.letters.item(h).get("width"), this.letters.item(h).set("padding", 0), this.letters.item(h).set({
                            ...
                            cornerSize: 6,
                            transparentCorners: !1
                        }), this.letters.item(h).set("padding", 0), this.letters.item(h).set("selectable", !1), this.letters.item(h).top = -1 * this.letters.item(h).get("fontSize") - h
                    } else if ("bulge" === this.effect) {
                        var p = parseInt(this.smallFont), v = parseInt(this.largeFont), b = v - p, m = Math.ceil(this.text.length / 2), y = b / (this.text.length - m);
                        if (m > h)var _ = p + h * y; else var _ = v - (h - m + 1) * y;
                        this.letters.item(h).set("fontSize", _), this.letters.item(h).set("left", l), l += this.letters.item(h).get("width"), this.letters.item(h).set("padding", 0), this.letters.item(h).set("selectable", !1), this.letters.item(h).set("top", -1 * this.letters.item(h).get("height") / 2)
                    }
                }
        ...
        _renderOld: function () {
            if (this.letters) {
                var t = 0, e = 0, i = 0;
                "center" === this.get("textAlign") || "justify" === this.get("textAlign") ? i = this.spacing / 2 * (this.text.length - 1) : "right" === this.get("textAlign") && (i = this.spacing * (this.text.length - 1));
                for (var r = this.reverse ? 1 : -1, s = 0, n = this.text.length; n > s; s++) {
                    t = r * (-s * parseInt(this.spacing, 10) + i), e = t * (Math.PI / 180);
                    for (var o in this.delegatedProperties)this.letters.item(s).set(o, this.get(o));
                    this.letters.item(s).set("top", -Math.cos(e) * this.radius), this.letters.item(s).set("left", +Math.sin(e) * this.radius), this.letters.item(s).setAngle(t), this.letters.item(s).set("padding", 0), this.letters.item(s).set("selectable", !1)
                }
                this.letters._calcBounds(), this.letters._updateObjectsCoords(), this.letters.saveCoords(), this.width = this.letters.width, this.height = this.letters.height, this.letters.left = -(this.letters.width / 2), this.letters.top = -(this.letters.height / 2)
            }
        },
        render: function (t) {
            if (this.visible && this.letters) {
                ...
                for (var i = 0, r = this.letters.size(); r > i; i++) {
                    {
                        var s = this.letters.item(i);
                        s.borderScaleFactor, s.hasRotatingPoint
                    }
                    s.visible && s.render(t)
                }
                this.clipTo && t.restore(), this.setCoords()
            }
        },
        _set: function (t, e) {
            this.callSuper("_set", t, e), this.letters && t in this._dimensionAffectingProps && (this._initDimensions(), this.setCoords())
        },
        toObject: function (t) {
            var e = i(this.callSuper("toObject", t), {
                radius: this.radius,
        ...
        toSVG: function (t) {
            ...
            if (this.letters)for (var i = 0, r = this.letters.size(); r > i; i++)e.push(this.letters.item(i).toSVG(t));
            return e.push("</g>"), t ? t(e.join("")) : e.join("")
        }
    }), e.CurvedText.fromObject = function (t) {
        return new e.CurvedText(t.text, r(t))
    }, e.util.createAccessors(e.CurvedText), e.CurvedText.async = !1
